...
const NavCard = ({title, active}) => {
  return (
    <div className='w-fit border-l-2 border-primary'>
        <div className={` text-slate-200 flex justify-between h-6 items-center big-shoulders p-1 overflow-hidden w-full xl:w-[196px] lg:w-[120px] md:w-[150px] ${active? 'bg-primary-trans':'inactive'}`}>
