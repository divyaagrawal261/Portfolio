...
function SkillCard({title, src}) {
    return (
        ...
        glareColor='blue'
        glareMaxOpacity={0.2}
            className="w-[90px] h-[90px] md:w-[120px] md:h-[120px] text-white aspect-square border-slate-900 border skillCard flex justify-center bg-red-800"
        >
            ...
            <div className="title iceland sm:text-2xl text-lg">{title}</div>
