  ...
  const action=bindActionCreators(actions, dispatch);
    ...
    return(
     ...
     L2.17,30.602l4.433-7.881l9.046-0.105l4.607,7.783L15.823,38.283z"
        ...
        <button className="border-primary border-2 flex justify-between items-center p-1 red big-shoulders hover-bg-primary hover:text-black font-bold z-10" onClick={()=>action.VisualVisibility(false)}>VISUAL SETTINGS
