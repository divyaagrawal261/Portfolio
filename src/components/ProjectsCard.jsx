...
export default function ProjectsCard({title, desc, image, date, detail, demo}) {
  return (
    ...
    <div className="innerBox border border-[#ffffff38] h-full">
      ...
      <div className="actionsContainer flex justify-between">
        <a href={detail}><button className='text-lg  border border-white p-1'>DETAILS</button></a>
        <a href={demo}><button className='text-lg  border border-white p-1'>DEMO</button></a>
      </div>
      </div>
    </div>
  </div>
